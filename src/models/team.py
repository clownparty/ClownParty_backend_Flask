...
class UserTeamModel(db.Model):
    ...
    slot3 = db.Column(db.Integer, nullable=False)
    slot4 = db.Column(db.Integer, nullable=False)
    slot5 = db.Column(db.Integer, nullable=False)
    slot6 = db.Column(db.Integer, nullable=False)
