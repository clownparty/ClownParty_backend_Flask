...
class TeamModel(db.Model):
    ...
    slot1 = db.Column(db.Integer, db.ForeignKey('pokemon.pokemonnumber'), nullable=False)
    slot2 = db.Column(db.Integer,db.ForeignKey('pokemon.pokemonnumber'), nullable=False)
    slot3 = db.Column(db.Integer, db.ForeignKey('pokemon.pokemonnumber'), nullable=False)
    slot4 = db.Column(db.Integer, db.ForeignKey('pokemon.pokemonnumber'), nullable=False)
    slot5 = db.Column(db.Integer, db.ForeignKey('pokemon.pokemonnumber'),  nullable=False)
    slot6 = db.Column(db.Integer, db.ForeignKey('pokemon.pokemonnumber'), nullable=False)
